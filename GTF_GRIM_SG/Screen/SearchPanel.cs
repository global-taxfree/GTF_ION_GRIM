    ...
    public partial class SearchPanel : UserControl
    {
        ...
        private void BTN_SEARCH_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!txt_GSTNo.Equals(""))
                {
                    jsonReq.Add("gst_no", txt_GSTNo.Text);
                }
                if (!txt_CompanyName.Text.Equals(""))
                {
                    jsonReq.Add("company_name", txt_CompanyName.Text);
                }
                if (!txt_StoreName.Text.Equals(""))
                {
                    jsonReq.Add("shop_name", txt_StoreName.Text);
                }
        ...
        public void AutoCompleteStore()
        {


            txt_StoreName.AutoCompleteMode = AutoCompleteMode.Suggest;
            txt_StoreName.AutoCompleteSource = AutoCompleteSource.CustomSource;
            AutoCompleteStringCollection storeAcsCollection = new AutoCompleteStringCollection();

            Transaction tran = new Transaction();
            string strRsult = tran.searchStoreName(txt_StoreName.Text);
            ...
            if (!strRsult.Equals(""))
            {
                ...
                foreach (JObject json in a.Children<JObject>())
                {
                    storeAcsCollection.Add(json["store_name"].ToString());
                }
            ...
            txt_StoreName.AutoCompleteCustomSource = storeAcsCollection;
        }
